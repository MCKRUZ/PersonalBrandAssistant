...
Generate content for section `section-05-caching-resilience` (filename: `section-05-caching-resilience.md`).
...
for `section-05-caching-resilience` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\08-analytics-dashboard/sections/section-05-caching-resilience.md`
