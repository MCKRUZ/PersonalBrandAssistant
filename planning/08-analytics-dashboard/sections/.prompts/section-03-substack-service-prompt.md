...
Generate content for section `section-03-substack-service` (filename: `section-03-substack-service.md`).
...
for `section-03-substack-service` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\08-analytics-dashboard/sections/section-03-substack-service.md`
