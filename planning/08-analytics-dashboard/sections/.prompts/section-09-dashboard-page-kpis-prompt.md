...
Generate content for section `section-09-dashboard-page-kpis` (filename: `section-09-dashboard-page-kpis.md`).
...
for `section-09-dashboard-page-kpis` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\08-analytics-dashboard/sections/section-09-dashboard-page-kpis.md`
