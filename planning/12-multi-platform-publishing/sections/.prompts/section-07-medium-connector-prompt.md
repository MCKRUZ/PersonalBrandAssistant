...
Generate content for section `section-07-medium-connector` (filename: `section-07-medium-connector.md`).
...
for `section-07-medium-connector` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\12-multi-platform-publishing/sections/section-07-medium-connector.md`
