...
Generate content for section `section-03-content-transformation` (filename: `section-03-content-transformation.md`).
...
for `section-03-content-transformation` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\12-multi-platform-publishing/sections/section-03-content-transformation.md`
