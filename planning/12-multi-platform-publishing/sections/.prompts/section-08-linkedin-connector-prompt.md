...
Generate content for section `section-08-linkedin-connector` (filename: `section-08-linkedin-connector.md`).
...
for `section-08-linkedin-connector` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\12-multi-platform-publishing/sections/section-08-linkedin-connector.md`
