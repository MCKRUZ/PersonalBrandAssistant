...
Generate content for section `section-04-blog-connector-migration` (filename: `section-04-blog-connector-migration.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\12-multi-platform-publishing/claude-plan.md` - Full implementation plan
2. `C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\12-multi-platform-publishing/claude-plan-tdd.md` - Test stubs for each section
3. `C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\12-multi-platform-publishing/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-04-blog-connector-migration` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\12-multi-platform-publishing/sections/section-04-blog-connector-migration.md`
