...
Generate content for section `section-14-frontend-editor` (filename: `section-14-frontend-editor.md`).
...
for `section-14-frontend-editor` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\12-multi-platform-publishing/sections/section-14-frontend-editor.md`
