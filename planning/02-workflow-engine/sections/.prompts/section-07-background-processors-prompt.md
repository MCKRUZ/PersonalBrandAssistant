...
Generate content for section `section-07-background-processors` (filename: `section-07-background-processors.md`).
...
for `section-07-background-processors` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\02-workflow-engine/sections/section-07-background-processors.md`
