...
Generate content for section `section-03-scoped-api-keys` (filename: `section-03-scoped-api-keys.md`).
...
for `section-03-scoped-api-keys` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\06-jarvis-integration/sections/section-03-scoped-api-keys.md`
