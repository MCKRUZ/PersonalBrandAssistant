...
Generate content for section `section-02-sse-broadcaster` (filename: `section-02-sse-broadcaster.md`).
...
for `section-02-sse-broadcaster` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\06-jarvis-integration/sections/section-02-sse-broadcaster.md`
