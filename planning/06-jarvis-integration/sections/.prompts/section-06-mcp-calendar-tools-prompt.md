...
Generate content for section `section-06-mcp-calendar-tools` (filename: `section-06-mcp-calendar-tools.md`).
...
for `section-06-mcp-calendar-tools` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\06-jarvis-integration/sections/section-06-mcp-calendar-tools.md`
