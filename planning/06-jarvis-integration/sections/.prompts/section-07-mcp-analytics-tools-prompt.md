...
Generate content for section `section-07-mcp-analytics-tools` (filename: `section-07-mcp-analytics-tools.md`).
...
for `section-07-mcp-analytics-tools` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\06-jarvis-integration/sections/section-07-mcp-analytics-tools.md`
