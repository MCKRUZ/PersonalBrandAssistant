...
Generate content for section `section-05-mcp-content-pipeline-tools` (filename: `section-05-mcp-content-pipeline-tools.md`).
...
for `section-05-mcp-content-pipeline-tools` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\06-jarvis-integration/sections/section-05-mcp-content-pipeline-tools.md`
