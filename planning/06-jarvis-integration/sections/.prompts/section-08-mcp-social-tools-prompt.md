...
Generate content for section `section-08-mcp-social-tools` (filename: `section-08-mcp-social-tools.md`).
...
for `section-08-mcp-social-tools` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\06-jarvis-integration/sections/section-08-mcp-social-tools.md`
