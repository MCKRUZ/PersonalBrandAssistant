...
Generate content for section `section-04-image-resizer` (filename: `section-04-image-resizer.md`).
...
for `section-04-image-resizer` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\07-linkedin-automation/sections/section-04-image-resizer.md`
