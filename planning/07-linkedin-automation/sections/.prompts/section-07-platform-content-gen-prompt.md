...
Generate content for section `section-07-platform-content-gen` (filename: `section-07-platform-content-gen.md`).
...
for `section-07-platform-content-gen` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\07-linkedin-automation/sections/section-07-platform-content-gen.md`
