...
Generate content for section `section-05-formatter-changes` (filename: `section-05-formatter-changes.md`).
...
for `section-05-formatter-changes` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\07-linkedin-automation/sections/section-05-formatter-changes.md`
