...
Generate content for section `section-02-comfyui-client` (filename: `section-02-comfyui-client.md`).
...
for `section-02-comfyui-client` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\07-linkedin-automation/sections/section-02-comfyui-client.md`
