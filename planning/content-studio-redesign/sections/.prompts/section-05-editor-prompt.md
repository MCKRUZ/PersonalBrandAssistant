...
Generate content for section `section-05-editor` (filename: `section-05-editor.md`).
...
for `section-05-editor` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\content-studio-redesign/sections/section-05-editor.md`
