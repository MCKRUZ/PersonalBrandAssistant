...
Generate content for section `section-06-rss-detection` (filename: `section-06-rss-detection.md`).
...
for `section-06-rss-detection` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\09-blog-publishing-workflow/sections/section-06-rss-detection.md`
