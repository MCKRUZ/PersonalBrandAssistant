...
Generate content for section `section-03-substack-prep-service` (filename: `section-03-substack-prep-service.md`).
...
for `section-03-substack-prep-service` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\09-blog-publishing-workflow/sections/section-03-substack-prep-service.md`
