...
Generate content for section `section-02-chat-authoring-backend` (filename: `section-02-chat-authoring-backend.md`).
...
for `section-02-chat-authoring-backend` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\09-blog-publishing-workflow/sections/section-02-chat-authoring-backend.md`
