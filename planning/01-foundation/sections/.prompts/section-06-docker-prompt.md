...
Generate content for section `section-06-docker` (filename: `section-06-docker.md`).
...
for `section-06-docker` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\01-foundation/sections/section-06-docker.md`
