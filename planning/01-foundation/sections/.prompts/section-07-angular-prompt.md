...
Generate content for section `section-07-angular` (filename: `section-07-angular.md`).
...
for `section-07-angular` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\01-foundation/sections/section-07-angular.md`
