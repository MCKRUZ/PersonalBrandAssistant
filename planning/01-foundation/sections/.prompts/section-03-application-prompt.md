...
Generate content for section `section-03-application` (filename: `section-03-application.md`).
...
for `section-03-application` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\01-foundation/sections/section-03-application.md`
