...
Generate content for section `section-05-api` (filename: `section-05-api.md`).
...
for `section-05-api` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\01-foundation/sections/section-05-api.md`
