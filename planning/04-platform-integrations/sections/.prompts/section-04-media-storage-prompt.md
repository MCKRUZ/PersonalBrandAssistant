...
Generate content for section `section-04-media-storage` (filename: `section-04-media-storage.md`).
...
for `section-04-media-storage` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\04-platform-integrations/sections/section-04-media-storage.md`
