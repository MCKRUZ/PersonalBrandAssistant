...
Generate content for section `section-07-content-formatters` (filename: `section-07-content-formatters.md`).
...
for `section-07-content-formatters` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\04-platform-integrations/sections/section-07-content-formatters.md`
