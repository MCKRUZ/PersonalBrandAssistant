...
Generate content for section `section-05-rate-limiter` (filename: `section-05-rate-limiter.md`).
...
for `section-05-rate-limiter` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\04-platform-integrations/sections/section-05-rate-limiter.md`
