...
Generate content for section `section-01-domain-entities` (filename: `section-01-domain-entities.md`).
...
for `section-01-domain-entities` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\04-platform-integrations/sections/section-01-domain-entities.md`
