...
Generate content for section `section-02-interfaces-models` (filename: `section-02-interfaces-models.md`).
...
for `section-02-interfaces-models` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\04-platform-integrations/sections/section-02-interfaces-models.md`
