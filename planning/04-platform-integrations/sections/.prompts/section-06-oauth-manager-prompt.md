...
Generate content for section `section-06-oauth-manager` (filename: `section-06-oauth-manager.md`).
...
for `section-06-oauth-manager` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\04-platform-integrations/sections/section-06-oauth-manager.md`
