...
Generate content for section `section-08-platform-adapters` (filename: `section-08-platform-adapters.md`).
...
for `section-08-platform-adapters` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\04-platform-integrations/sections/section-08-platform-adapters.md`
