...
Generate content for section `section-05-prompt-system` (filename: `section-05-prompt-system.md`).
...
for `section-05-prompt-system` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\03-agent-orchestration/sections/section-05-prompt-system.md`
