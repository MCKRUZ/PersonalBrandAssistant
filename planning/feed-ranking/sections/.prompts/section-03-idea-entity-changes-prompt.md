...
Generate content for section `section-03-idea-entity-changes` (filename: `section-03-idea-entity-changes.md`).
...
for `section-03-idea-entity-changes` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\feed-ranking/sections/section-03-idea-entity-changes.md`
