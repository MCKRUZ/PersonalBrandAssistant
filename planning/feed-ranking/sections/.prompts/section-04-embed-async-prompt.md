...
Generate content for section `section-04-embed-async` (filename: `section-04-embed-async.md`).
...
for `section-04-embed-async` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\feed-ranking/sections/section-04-embed-async.md`
