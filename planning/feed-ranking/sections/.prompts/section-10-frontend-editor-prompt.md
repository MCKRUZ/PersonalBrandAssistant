...
Generate content for section `section-10-frontend-editor` (filename: `section-10-frontend-editor.md`).
...
for `section-10-frontend-editor` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\feed-ranking/sections/section-10-frontend-editor.md`
