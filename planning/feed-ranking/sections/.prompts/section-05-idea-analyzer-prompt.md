...
Generate content for section `section-05-idea-analyzer` (filename: `section-05-idea-analyzer.md`).
...
for `section-05-idea-analyzer` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\feed-ranking/sections/section-05-idea-analyzer.md`
