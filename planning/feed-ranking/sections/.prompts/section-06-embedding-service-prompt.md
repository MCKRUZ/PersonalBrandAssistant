...
Generate content for section `section-06-embedding-service` (filename: `section-06-embedding-service.md`).
...
for `section-06-embedding-service` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\feed-ranking/sections/section-06-embedding-service.md`
