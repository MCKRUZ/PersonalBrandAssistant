...
Generate content for section `section-03-agent-refactoring` (filename: `section-03-agent-refactoring.md`).
...
for `section-03-agent-refactoring` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\05-content-engine/sections/section-03-agent-refactoring.md`
