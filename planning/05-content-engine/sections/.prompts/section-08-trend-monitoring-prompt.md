...
Generate content for section `section-08-trend-monitoring` (filename: `section-08-trend-monitoring.md`).
...
for `section-08-trend-monitoring` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\05-content-engine/sections/section-08-trend-monitoring.md`
