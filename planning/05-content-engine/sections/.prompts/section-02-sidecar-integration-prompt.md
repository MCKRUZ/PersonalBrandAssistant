...
Generate content for section `section-02-sidecar-integration` (filename: `section-02-sidecar-integration.md`).
...
for `section-02-sidecar-integration` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\personal-brand-assistant\planning\05-content-engine/sections/section-02-sidecar-integration.md`
