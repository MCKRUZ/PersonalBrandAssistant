...
@Component({
  ...
  imports: [FormsModule, ButtonModule, Tag, KnobModule, AccordionModule],
  template: `
                ...
                <div class="opp-card__articles">
                  @for (article of opportunity().articles; track article.id) {
                    <a
                      ...
                      [style.--article-color]="getSourceColor(article.sourceName)"
                    >
  ...
  styles: `
    ...
    @media (max-width: 768px) {
      ...
      .opp-card__header h3 { font-size: 0.95rem; }
      .opp-card__rationale { font-size: 0.8rem; }
      .opp-card__expand { padding: 0 1rem 1rem; }
      .opp-card__article { font-size: 0.78rem; }
