...
@Component({
    ...
    <article class="video-card" [class.video-card--no-thumb]="thumbError()" [style.--source-color]="categoryColor()">
      ...
      <div class="video-card__body">
        <div class="video-card__meta">
          ...
          <span class="video-card__source-name">{{ item().sourceName }}</span>
  ...
  styles: `
    ...
    @media (max-width: 768px) {
      ...
      .video-card__body { padding: 0.75rem 0.85rem; gap: 0.35rem; }
      .video-card__meta { gap: 0.35rem; font-size: 0.72rem; }
      .video-card__title { font-size: 0.9rem; }
      .video-card__summary { font-size: 0.8rem; -webkit-line-clamp: 1; }
      .video-card__actions { gap: 0.25rem; }
      .video-card__action {
        padding: 0.4rem;
        font-size: 0;
        border-radius: 6px;
      }
      .video-card__action i { font-size: 0.9rem; }
