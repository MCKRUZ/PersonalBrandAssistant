...
@Component({
  ...
  styles: [`
    ...
    @media (max-width: 768px) {
      .nhub { padding: 0 0.75rem 1rem; }
      .nhub-hero { padding: 1.25rem 0 0.75rem; }
      .nhub-hero__orb { display: none; }
      .nhub-hero__title { font-size: 1.5rem; }
      .nhub-hero__sub { font-size: 0.8rem; }
      .nhub-badge { font-size: 0.6rem; padding: 0.2rem 0.6rem; margin-bottom: 0.5rem; }
      .nhub-tabs .p-tab {
        font-size: 0.78rem !important;
        padding: 0.65rem 0.6rem !important;
      }
      .nhub-tabs .p-tab .mr-2 { margin-right: 0.3rem !important; }
      .nhub-tabs .p-tabpanels { padding: 1rem 0 0 !important; }
      .nhub-tab-count { font-size: 0.6rem; padding: 0.08rem 0.35rem; }
      .nhub-refresh-status { padding: 0 0.5rem; font-size: 0.7rem; }
      .nhub-refresh-status span:not(.nhub-refresh-status__delta) { display: none; }
    }
